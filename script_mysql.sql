...
CREATE TABLE modelo (
    ...
    CONSTRAINT uq_modelo_marca UNIQUE (nome, id_marca)
) ENGINE=InnoDB;
...
CREATE TABLE usuario (
    ...
    tipo ENUM('cliente','concessionaria','admin') 
...
CREATE TABLE veiculo (
    ...
    INDEX idx_combustivel (id_combustivel),
...
CREATE TABLE imagem (
    ...
    INDEX idx_imagem_veiculo (id_veiculo),
...
CREATE TABLE avaliacao (
    ...
    INDEX idx_avaliacao_veiculo (id_veiculo),
    ...
    CONSTRAINT fk_avaliacao_veiculo
        FOREIGN KEY (id_veiculo)
        REFERENCES veiculo(id_veiculo)
        ON DELETE CASCADE
        ON UPDATE CASCADE
...
CREATE TABLE favoritos (
    ...
    INDEX idx_favoritos_veiculo (id_veiculo),
    ...
    CONSTRAINT fk_favoritos_veiculo
        FOREIGN KEY (id_veiculo)
        REFERENCES veiculo(id_veiculo)
        ON DELETE CASCADE
        ON UPDATE CASCADE
...
CREATE TABLE concessionaria (
    ...
    CONSTRAINT fk_concessionaria_usuario
        FOREIGN KEY (id_usuario)
        REFERENCES usuario(id_usuario)
        ON DELETE CASCADE
        ON UPDATE CASCADE
